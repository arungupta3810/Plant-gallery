...
const PLANTS = [
  { slug: 'monstera', name: 'Swiss Cheese Plant', botanical: 'Monstera deliciosa', price: 1899, cat: 'Indoor', light: 'Bright, indirect', water: 'Weekly', difficulty: 'Easy', petSafe: false, badge: 'New', icon: 'leaf', theme: ['#D7E9D8', '#A5D6A7'], stock: 12 },
  { slug: 'snake', name: 'Snake Plant', botanical: 'Sansevieria trifasciata', price: 1299, cat: 'Low light', light: 'Low to bright', water: 'Every 2–3 wks', difficulty: 'Hard to kill', petSafe: false, badge: null, icon: 'sprout', theme: ['#E6E3DA', '#C9D6C2'], stock: 20 },
  { slug: 'fiddle', name: 'Fiddle Leaf Fig', botanical: 'Ficus lyrata', price: 2549, oldPrice: 3199, cat: 'Statement', light: 'Bright, indirect', water: 'Weekly', difficulty: 'Fussy', petSafe: false, badge: '20% off', icon: 'tree', theme: ['#DCEAD9', '#9FCBA0'], stock: 6 },
  { slug: 'pothos', name: 'Golden Pothos', botanical: 'Epipremnum aureum', price: 949, cat: 'Hanging', light: 'Low to bright', water: 'Weekly', difficulty: 'Hard to kill', petSafe: false, badge: 'Bestseller', icon: 'leaf', theme: ['#EAF2E3', '#BFD9A0'], stock: 30 },
  { slug: 'zz', name: 'ZZ Plant', botanical: 'Zamioculcas zamiifolia', price: 1499, cat: 'Low light', light: 'Low to bright', water: 'Every 2–3 wks', difficulty: 'Hard to kill', petSafe: false, badge: null, icon: 'sprout', theme: ['#E2E8DA', '#AFC9A6'], stock: 14 },
  { slug: 'calathea', name: 'Prayer Plant', botanical: 'Calathea orbifolia', price: 1699, cat: 'Indoor', light: 'Medium, indirect', water: 'Keep moist', difficulty: 'Fussy', petSafe: true, badge: 'Pet-safe', icon: 'leaf', theme: ['#D4E7D6', '#A7D3A9'], stock: 9 },
  { slug: 'rubber', name: 'Rubber Plant', botanical: 'Ficus elastica', price: 1799, cat: 'Statement', light: 'Bright, indirect', water: 'Weekly', difficulty: 'Easy', petSafe: false, badge: null, icon: 'tree', theme: ['#E0EAD8', '#A9CFA0'], stock: 11 },
  { slug: 'peace', name: 'Peace Lily', botanical: 'Spathiphyllum', price: 1349, cat: 'Flowering', light: 'Low to medium', water: 'Weekly', difficulty: 'Easy', petSafe: false, badge: null, icon: 'flower', theme: ['#DDEBDB', '#A3D2A8'], stock: 16 },
  { slug: 'aloe', name: 'Aloe Vera', botanical: 'Aloe barbadensis', price: 849, cat: 'Succulent', light: 'Bright, direct', water: 'Every 2–3 wks', difficulty: 'Hard to kill', petSafe: false, badge: null, icon: 'sprout', theme: ['#E8EEDD', '#C2D6A4'], stock: 25 },
  { slug: 'spider', name: 'Spider Plant', botanical: 'Chlorophytum comosum', price: 999, cat: 'Hanging', light: 'Bright, indirect', water: 'Weekly', difficulty: 'Hard to kill', petSafe: true, badge: 'Pet-safe', icon: 'leaf', theme: ['#E4EFDD', '#B6D6A2'], stock: 18 },
  { slug: 'palm', name: 'Areca Palm', botanical: 'Dypsis lutescens', price: 2299, cat: 'Statement', light: 'Bright, indirect', water: 'Weekly', difficulty: 'Easy', petSafe: true, badge: 'Pet-safe', icon: 'tree', theme: ['#DBEAD7', '#A0CC9C'], stock: 7 },
  { slug: 'philo', name: 'Heartleaf Philodendron', botanical: 'Philodendron hederaceum', price: 1099, cat: 'Hanging', light: 'Low to bright', water: 'Weekly', difficulty: 'Easy', petSafe: false, badge: null, icon: 'leaf', theme: ['#E1ECDA', '#ACD0A4'], stock: 22 },
];
...
const FAQS = [
  { question: 'How fast is delivery?', answer: 'Orders ship within 2–3 business days across Mumbai. Free delivery on orders over ₹250.', order: 1 },
...
async function main() {
  ...
  await prisma.banner.create({
    data: { title: 'Free delivery in Mumbai on orders over ₹250', subtitle: 'Healthy-arrival guarantee', href: '/shop', order: 1 },
  });
